 ...
 */
public class TemplateOrChoices_manila extends AppCompatActivity implements View.OnClickListener, GestureDetector.OnGestureListener {

    Context mContext = TemplateOrChoices_manila.this;
    ...
    private String[] tagLines = {
            "Hello, Welcome to Manila. Please have a look at what we offer. \n Slide down to select which mode you prefer.",
                ...
                switch (tilesContainer.indexOfChild(v)) {
                    ...
                    case 1:
                        if (tilesContainer.getChildAt(1).getLayoutParams().height != firstChildHeight) {
                            ...
                            Intent intent = new Intent(this, Packagesets_manila.class);
                    ...
                    case 2:
                        if (tilesContainer.getChildAt(2).getLayoutParams().height != firstChildHeight) {
                            ...
                            Intent intent = new Intent(this, ChoicesOfPlace_Manila.class);
                            startActivity(intent);
                            packages = 0;
        ...
        switch (v.getTag().toString()) {
            ...
            case "1":
                ...
                if (tilesContainer.getChildAt(1).getLayoutParams().height != firstChildHeight) {
                    ...
                    Intent intent = new Intent(this, Packagesets_manila.class); //ChoicesOfPackage
                    startActivity(intent);
                    finish();
                    packages = 1;
                }
