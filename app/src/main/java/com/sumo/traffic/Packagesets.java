 ...
 */
public class Packagesets extends AppCompatActivity implements View.OnClickListener, GestureDetector.OnGestureListener {

    Context mContext = Packagesets.this;
                ...
                switch (tilesContainer.indexOfChild(v)) {
                    ...
                    case 1:
                        if (tilesContainer.getChildAt(1).getLayoutParams().height != firstChildHeight) {
                            ...
                            Intent intent = new Intent(this, Pack1.class);
