 ...
 */
public class PacoPark extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.place_manila_pacopark);
    ...
    private class FetchReviews extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... args) {
            String url = "https://maps.googleapis.com/maps/api/place/details/json?placeid="
                    + "ChIJCZYEzInJlzMR3mf_SZ0OMC8" + "&key=AIzaSyDK1zxUEp38e6sQYzJq6qGNKxdOUqUZR1Y";
        ...
        protected void onPostExecute(String json) {
            try {
                ...
                layoutManager = new LinearLayoutManager(PacoPark.this);
