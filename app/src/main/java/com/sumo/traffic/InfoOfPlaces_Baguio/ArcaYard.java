 ...
 */
public class ArcaYard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.place_baguio_arcasyard);
    ...
    private class FetchReviews extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... args) {
            String url = "https://maps.googleapis.com/maps/api/place/details/json?placeid="
                    + "ChIJu9TKLgakkTMRLXbs9P7ImJA" + "&key=AIzaSyDK1zxUEp38e6sQYzJq6qGNKxdOUqUZR1Y";
