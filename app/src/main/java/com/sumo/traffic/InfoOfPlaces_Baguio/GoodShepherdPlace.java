 ...
 */
public class GoodShepherdPlace extends AppCompatActivity {
...
Context context;
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.place_baguio_goodshepherd);
    ...
    private class FetchReviews extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... args) {
            String url = "https://maps.googleapis.com/maps/api/place/details/json?placeid="
                    + "ChIJd8MMYQGkkTMRRot_a8URm-M" + "&key=AIzaSyDK1zxUEp38e6sQYzJq6qGNKxdOUqUZR1Y";
